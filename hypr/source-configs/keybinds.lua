...
hl.gesture({
    ...
    -- TODO: manual review — extra gesture field "playerctl play-pause"
})
hl.gesture({
    fingers = 3,
    direction = "left",
    action = "dispatcher",
    -- TODO: manual review — extra gesture field "exec"
    -- TODO: manual review — extra gesture field "playerctl previous"
})
hl.gesture({
    fingers = 3,
    direction = "right",
    action = "dispatcher",
    -- TODO: manual review — extra gesture field "exec"
    -- TODO: manual review — extra gesture field "playerctl next"
})
