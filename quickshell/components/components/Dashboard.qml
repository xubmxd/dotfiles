...
Item {
    ...
    Timer { interval: 5000; running: dashboardRoot.visible; repeat: true; onTriggered: wifiProc.running = true; Component.onCompleted: wifiProc.running = true }
    Timer { interval: 10000; running: dashboardRoot.visible; repeat: true; onTriggered: batProc.running = true; Component.onCompleted: batProc.running = true }
        ...
        Item {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Timer {
                        interval: 1000; running: mainView.visible; repeat: true
                        onTriggered: {
